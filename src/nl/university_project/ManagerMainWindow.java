...
public class ManagerMainWindow {
    ...
    public ManagerMainWindow(User currentUser, InitUsers allUsers) {
    ...
    public void setUp() {
        ...
        stage.setTitle("Hello mr./mrs. " + currentUser.getLastName() + " (admin access)");
        ...
        MenuItem exportReportsMenu = new MenuItem("Export reports");

        menu.getItems().add(exitMenu);
        usersMenu.getItems().addAll(studentsMenu, teachersMenu);
        reportsMenu.getItems().addAll(showReportsMenu, exportReportsMenu);
        ...
        exportReportsMenu.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                exportAllReportsToDocFile();
            }
        });
    ...
    private void exportAllReportsToDocFile() {
        for (Report report : allUsers.getAllReports()) {
            ...
            String fullReport = "Report of student " + report.getFirstName() + " " + report.getLastName() + "\n\n" +
                                "Student Id ..............  " + report.getStudentId() + "\n" +
                                "First Name ..............  " + report.getFirstName() + "\n" +
                                "Last Name  ..............  " + report.getLastName() + "\n" +
                                "Birthdate  ..............  " + report.getBirthDate() + "\n" +
                                "Age    ..................  " + report.getAge() + "\n" +
                                "Group  ..................  " + report.getGroup() + "\n\n" +
                                "           COURSES\n\n" +
                                "Java   ..................  " + report.getJavaGrade() + "\n" +
                                "CSharp ..................  " + report.getCSharpGrade() + "\n" +
                                "Python ..................  " + report.getPythonGrade() + "\n" +
                                "PHP    ..................  " + report.getPhpGrade() + "\n\n" +
                                "           RESULT\n\n" +
                                "Result ..................  " + passed;

            try (FileOutputStream fos = new FileOutputStream(new File("src/nl/university_project/studentReports/" + report.getStudentId() + " " + report.getFirstName() + " " + report.getLastName() + ".doc"));) {
                fos.write(fullReport.getBytes());
            }
            catch (IOException e)
            {
                e.printStackTrace();
